 ...
 * command, but alfriendschat replaces the chat field's change listener with its own
...
public final class IMBlockerCompat {
    ...
    private static void resolve() {
        ...
        try {
            ...
            E33Log.debug("[alfriendschat] IMBlocker not present, IME state sync disabled: {}", t.toString());
        }
    }
    ...
    public static void setCommandMode(Object textField, boolean command) {
        ...
        try {
            ...
            E33Log.debug("[alfriendschat] IMBlocker sync failed: {}", t.toString());
        }
    }
}
