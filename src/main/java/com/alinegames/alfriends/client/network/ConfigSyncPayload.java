...
//#endif
    ...
    public static final CustomPayload.Id<ConfigSyncPayload> ID =
        new CustomPayload.Id<>(
            //#if MC >= 12000
            Identifier.of("alfriendschat", "config_sync")
            //#else
            //$$ new Identifier("alfriendschat", "config_sync")
            //#endif
        );
    ...
    //#else
    //$$ public static final Identifier ID = new Identifier("alfriendschat", "config_sync");
    //#endif
