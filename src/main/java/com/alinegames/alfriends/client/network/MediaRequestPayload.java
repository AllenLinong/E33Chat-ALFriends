...
//#endif
    ...
    public static final CustomPayload.Id<MediaRequestPayload> ID =
        new CustomPayload.Id<>(
            //#if MC >= 12000
            Identifier.of("alfriendschat", "media_request")
            //#else
            //$$ new Identifier("alfriendschat", "media_request")
            //#endif
        );
    ...
    //#else
    //$$ public static final Identifier ID = new Identifier("alfriendschat", "media_request");
    //#endif
}
