...
public record ConfigSyncV2Payload(boolean useTpa, List<String> chatTemplates,
    ...
    public static final CustomPayload.Id<ConfigSyncV2Payload> ID =
        new CustomPayload.Id<>(
            //#if MC >= 12000
            Identifier.of("alfriendschat", "config_sync_v2")
            //#else
            //$$ new Identifier("alfriendschat", "config_sync_v2")
            //#endif
        );
    ...
    //#else
    //$$ public static final Identifier ID = new Identifier("alfriendschat", "config_sync_v2");
    //#endif
