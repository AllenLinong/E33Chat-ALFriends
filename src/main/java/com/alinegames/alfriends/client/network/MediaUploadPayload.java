...
public record MediaUploadPayload(long uploadId, int index, int totalChunks,
    ...
    public static final CustomPayload.Id<MediaUploadPayload> ID =
        new CustomPayload.Id<>(
            //#if MC >= 12000
            Identifier.of("alfriendschat", "media_upload")
            //#else
            //$$ new Identifier("alfriendschat", "media_upload")
            //#endif
        );
    ...
    //#else
    //$$ public static final Identifier ID = new Identifier("alfriendschat", "media_upload");
    //#endif
}
