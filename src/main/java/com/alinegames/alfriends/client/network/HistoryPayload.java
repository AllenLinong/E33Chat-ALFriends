...
public record HistoryPayload(List<HistoryPayload.HistoryEntry> entries)
    ...
    public static final CustomPayload.Id<HistoryPayload> ID =
        new CustomPayload.Id<>(
            //#if MC >= 12000
            Identifier.of("alfriendschat", "chat_history")
            //#else
            //$$ new Identifier("alfriendschat", "chat_history")
            //#endif
        );
    //#else
    //$$ public static final Identifier ID = new Identifier("alfriendschat", "chat_history");
    //#endif
