 ...
 * successful (URL becomes alfriendschat://media/<mediaId>); otherwise error holds a
...
public record MediaUploadAckPayload(long uploadId, String mediaId, String error)
    ...
    public static final CustomPayload.Id<MediaUploadAckPayload> ID =
        new CustomPayload.Id<>(
            //#if MC >= 12000
            Identifier.of("alfriendschat", "media_upload_ack")
            //#else
            //$$ new Identifier("alfriendschat", "media_upload_ack")
            //#endif
        );
    ...
    //#else
    //$$ public static final Identifier ID = new Identifier("alfriendschat", "media_upload_ack");
    //#endif
