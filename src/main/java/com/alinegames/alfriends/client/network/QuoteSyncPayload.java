...
//#endif
    ...
    public static final CustomPayload.Id<QuoteSyncPayload> ID =
        new CustomPayload.Id<>(
            //#if MC >= 12000
            Identifier.of("alfriendschat", "quote_sync")
            //#else
            //$$ new Identifier("alfriendschat", "quote_sync")
            //#endif
        );
    ...
    //#else
    //$$ public static final Identifier ID = new Identifier("alfriendschat", "quote_sync");
    //#endif
}
