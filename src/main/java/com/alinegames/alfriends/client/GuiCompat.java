...
import com.alinegames.alfriends.client.mixin.ScreenAccessor;
...
public final class GuiCompat {
    ...
    public static <T extends ClickableWidget> T addDrawableChild(Screen screen, T widget) {
        ...
        //#if MC >= 11900
        try {
            return ((ScreenAccessor) screen).alfriendschat$addDrawableChild(widget);
    ...
    public static void clearChildren(Screen screen) {
        ...
        //#if MC >= 11900
        try {
            ((ScreenAccessor) screen).alfriendschat$clearChildren();
            return;
        } catch (Throwable ignored) {
        }
        //#endif
    ...
    public static Text doneText() {
        ...
        //#else
        //$$ return com.alinegames.alfriends.client.Txt.translatable("gui.done");
        //#endif
    }
    ...
    public static Text onText() {
        ...
        //#else
        //$$ return com.alinegames.alfriends.client.Txt.translatable("options.on");
        //#endif
    }
    ...
    public static Text offText() {
        ...
        //#else
        //$$ return com.alinegames.alfriends.client.Txt.translatable("options.off");
        //#endif
    }
    ...
    public static void sendChat(ClientPlayNetworkHandler handler, String text) {
        ...
        //$$     MinecraftClient.getInstance().player.sendChatMessage(text, com.alinegames.alfriends.client.Txt.empty());
        //$$ }
        //#else
        //$$ if (MinecraftClient.getInstance().player != null) {
    ...
    public static Object soundInstance(Object event, float pitch, float volume) {
        //#if MC >= 26000
        return null;
        //#else
        return null;
