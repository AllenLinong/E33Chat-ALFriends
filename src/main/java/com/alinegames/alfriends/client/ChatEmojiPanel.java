...
public class ChatEmojiPanel {
    ...
    public void render(Object g, int mouseX, int mouseY,
        ...
        String[] tabLabels = {
            com.alinegames.alfriends.client.Txt.translatable("alfriendschat.emoji.tab_emoji").getString(),
            com.alinegames.alfriends.client.Txt.translatable("alfriendschat.emoji.tab_kaomoji").getString(),
            com.alinegames.alfriends.client.Txt.translatable("alfriendschat.emoji.tab_custom").getString()
        };
        int tabW = pw / tabLabels.length;
        ColoredTextureRenderer.drawWithAlpha(g,
            com.alinegames.alfriends.client.texture.UiTextureManager.rl(com.alinegames.alfriends.client.texture.UiElement.TITLE_BAR),
        ...
        ColoredTextureRenderer.drawWithAlpha(g,
            com.alinegames.alfriends.client.texture.UiTextureManager.rl(com.alinegames.alfriends.client.texture.UiElement.DIVIDER),
        ...
        int divA = com.alinegames.alfriends.client.ChatBubbleTheme.alphaBlend(c.divider(), a255);
            ...
            if (i < serverEmotes.size()) {
                ...
                if (tex != null)
                    ...
                    RenderHelper.drawText(g, font, "?", ex + EMOTE_SLOT / 2 - 3,
                        ey + (EMOTE_SLOT - font.fontHeight) / 2,
                        com.alinegames.alfriends.client.ChatBubbleTheme.alphaBlend(c.textMuted(), a255), false);
                if (hover) {
                    ColoredTextureRenderer.drawWithAlpha(g,
                        com.alinegames.alfriends.client.texture.UiTextureManager.rl(com.alinegames.alfriends.client.texture.UiElement.CLOSE_BG),
                        ex + EMOTE_SLOT - 10, ey, 10, 10, alpha);
                    RenderHelper.drawText(g, font, "✕", ex + EMOTE_SLOT - 8, ey + 1,
                        com.alinegames.alfriends.client.ChatBubbleTheme.alphaBlend(c.closeText(), a255), false);
                }
            } else {
                RenderHelper.drawText(g, font, "+", ex + EMOTE_SLOT / 2 - 3,
                    ey + (EMOTE_SLOT - font.fontHeight) / 2,
    ...
    private void renderEmojiGrid(Object g, int mouseX, int mouseY,
        ...
        for (int i = 0; i < EMOTES.length; i++) {
            ...
            RenderHelper.drawText(g, font, emoji,
                ...
                ey + (SLOT - font.fontHeight) / 2, com.alinegames.alfriends.client.ChatBubbleTheme.alphaBlend(c.textPrimary(), a255), false);
        }
        RenderHelper.disableScissor(g);
    }
    ...
    private void renderKaomojiList(Object g, int mouseX, int mouseY,
        ...
        for (int i = 0; i < KAO.length; i++) {
            ...
            RenderHelper.drawText(g, font, KAO[i],
                ex + 2, ey + (KAO_ITEM_H - font.fontHeight) / 2, com.alinegames.alfriends.client.ChatBubbleTheme.alphaBlend(c.textPrimary(), a255), false);
        }
        RenderHelper.disableScissor(g);
    }
