...
public class ChatSettingsMenu {
    ...
    public void render(Object g, int mouseX, int mouseY,
        ...
        com.alinegames.alfriends.client.texture.ColoredTextureRenderer.drawWithAlpha(g,
            ...
            px, py, W, menuH, alpha);
        drawBorder(g, px, py, W, menuH, com.alinegames.alfriends.client.ChatBubbleTheme.alphaBlend(c.divider(), a255));
        ...
        String[] labels = {
            com.alinegames.alfriends.client.Txt.translatable("alfriendschat.menu.search").getString(),
            com.alinegames.alfriends.client.Txt.translatable("alfriendschat.menu.quick_chat").getString(),
            com.alinegames.alfriends.client.Txt.translatable("alfriendschat.menu.theme").getString(),
            com.alinegames.alfriends.client.Txt.translatable("alfriendschat.menu.settings").getString()
        };
        ...
        for (int i = 0; i < COUNT; i++) {
            ...
            RenderHelper.drawText(g, font, label, px + 20, ry + 4, com.alinegames.alfriends.client.ChatBubbleTheme.alphaBlend(c.textPrimary(), a255), false);
        }
    }
