...
public final class LocalImageSource {
    ...
    public static PreparedImage fromFile(File f) {
        ...
        try {
            ...
            if (bi == null) {
                LOGGER.info("[alfriendschat] upload: unsupported file {}", f.getName());
                return null;
            }
            return encode(bi, f.getName());
        } catch (Throwable t) {
            LOGGER.info("[alfriendschat] upload: read failed {}: {}", f.getName(), t.toString());
            return null;
        }
    }
    ...
    public static PreparedImage fromClipboard() {
        try {
            ...
            LOGGER.debug("[alfriendschat] upload: clipboard read failed: {}", t.toString());
            return null;
        }
    }
    ...
    private static byte[] toJpeg(BufferedImage img) {
        try {
            ...
            LOGGER.debug("[alfriendschat] upload: jpeg encode failed: {}", t.toString());
            return null;
        }
    }
