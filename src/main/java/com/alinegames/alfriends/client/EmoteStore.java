...
/**
 * Local emote pack (2.4.0 sync): static images in &lt;runDir&gt;/alfriendschat/emotes/
...
public final class EmoteStore {
    ...
    public static File dir() {
        return FabricLoader.getInstance().getConfigDir().resolve("alfriendschat/emotes").toFile();
    }
    ...
    public static Identifier texture(File f) {
        ...
        try {
            ...
            if (dec == null) {
                E33Log.warn("[alfriendschat] emote decode failed: {}", f.getName());
                return null;
            }
            ...
            Identifier tex;
            //#if MC >= 11900
            tex = Identifier.of("alfriendschat", "emote/" + (textureSeq++));
            //#else
            //$$ tex = new Identifier("alfriendschat", "emote/" + (textureSeq++));
            //#endif
            ...
            E33Log.warn("[alfriendschat] emote read failed: {}", f.getName());
            return null;
        }
    }
}
