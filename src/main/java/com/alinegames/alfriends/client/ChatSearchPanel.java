...
public class ChatSearchPanel {
    ...
    public void render(Object g, int mouseX, int mouseY,
        ...
        drawBorder(g, px, py, w, PANEL_H, com.alinegames.alfriends.client.ChatBubbleTheme.alphaBlend(c.divider(), a255));
        ...
        if (!searchInput.getText().isEmpty()) {
            if (searchMatches.isEmpty())
                counter = com.alinegames.alfriends.client.Txt.translatable("alfriendschat.search.no_match").getString();
            else
        ...
        if (hoverInput || searchInput.isFocused())
            drawBorder(g, inputX, inputY, inputW, INPUT_H, com.alinegames.alfriends.client.ChatBubbleTheme.alphaBlend(c.textMuted(), a255));
        ...
        if (!counter.isEmpty()) {
            ...
            RenderHelper.drawText(g, font, counter, inputX + inputW - counterW, inputY + 3,
                com.alinegames.alfriends.client.ChatBubbleTheme.alphaBlend(cc, a255), false);
        }
        ...
        if (searchInput.getText().isEmpty()) {
            String ph = com.alinegames.alfriends.client.Txt.translatable("alfriendschat.search.placeholder").getString();
            RenderHelper.drawText(g, font, ph, inputX + 2, inputY + 3, com.alinegames.alfriends.client.ChatBubbleTheme.alphaBlend(c.textMuted(), a255), false);
        }
    }
