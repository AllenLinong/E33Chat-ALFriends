...
public class ChatQuickChatPanel {
    ...
    public void render(Object g, int mouseX, int mouseY,
        ...
        com.alinegames.alfriends.client.texture.ColoredTextureRenderer.drawWithAlpha(g,
            com.alinegames.alfriends.client.texture.UiTextureManager.rl(com.alinegames.alfriends.client.texture.UiElement.CONTENT_BG),
            px, py, W, panelH, alpha);
        drawBorder(g, px, py, W, panelH, com.alinegames.alfriends.client.ChatBubbleTheme.alphaBlend(c.divider(), a255));
        ...
        if (hasScrollbar) {
            ...
            com.alinegames.alfriends.client.texture.ColoredTextureRenderer.drawTinted(g,
                com.alinegames.alfriends.client.texture.UiTextureManager.rl(com.alinegames.alfriends.client.texture.UiElement.QUICK_SCROLLBAR_TRACK),
            ...
            com.alinegames.alfriends.client.texture.ColoredTextureRenderer.drawTinted(g,
                com.alinegames.alfriends.client.texture.UiTextureManager.rl(com.alinegames.alfriends.client.texture.UiElement.QUICK_SCROLLBAR_THUMB),
        ...
        for (int i = startIdx; i < endIdx; i++) {
            ...
            if (hover) com.alinegames.alfriends.client.texture.ColoredTextureRenderer.drawWithAlpha(g,
            ...
            RenderHelper.drawText(g, font, display, px + 6, rowY + 2, com.alinegames.alfriends.client.ChatBubbleTheme.alphaBlend(c.textPrimary(), a255), false);
            int delX = hoverRight - 13;
            int delY = rowY + 1;
            boolean hoverDel = mouseX >= delX && mouseX <= delX + 12 && mouseY >= delY && mouseY <= delY + 12;
            com.alinegames.alfriends.client.texture.ColoredTextureRenderer.drawWithAlpha(g,
                com.alinegames.alfriends.client.texture.UiTextureManager.rl(hoverDel
                    ? com.alinegames.alfriends.client.texture.UiElement.CLOSE_HOVER
                    : com.alinegames.alfriends.client.texture.UiElement.CLOSE_BG),
                delX, delY, 12, 12, alpha);
            RenderHelper.drawText(g, font, "\u2715", delX + 6 - font.getWidth("\u2715") / 2, delY + 2, com.alinegames.alfriends.client.ChatBubbleTheme.alphaBlend(c.closeText(), a255), false);
        }
        ...
        int inputH = 14;
        com.alinegames.alfriends.client.texture.ColoredTextureRenderer.drawWithAlpha(g,
            com.alinegames.alfriends.client.texture.UiTextureManager.rl(com.alinegames.alfriends.client.texture.UiElement.INPUT_BG),
        ...
        if (hoverInput || input.isFocused())
            drawBorder(g, inputX, inputY, inputW, inputH, com.alinegames.alfriends.client.ChatBubbleTheme.alphaBlend(c.textMuted(), a255));
        if (input.getText().isEmpty() && !input.isFocused())
            RenderHelper.drawText(g, font, com.alinegames.alfriends.client.Txt.translatable("alfriendschat.quick_chat.placeholder").getString(),
                inputX + 2, inputY + 3, com.alinegames.alfriends.client.ChatBubbleTheme.alphaBlend(c.textMuted(), a255), false);
