package com.alinegames.alfriends.client.texture;

import com.alinegames.alfriends.client.ChatBubbleTheme;
import net.minecraft.util.Identifier;

/** UI 纹理元素：资源包路径。路径约定 assets/alfriendschat/textures/gui/{theme}/{path}.png，默认纹理为 jar 内置 16×16 PNG。 */
public enum UiElement {
    ...
    public Identifier rl(ChatBubbleTheme theme) {
        return Identifier.of("alfriendschat",
